...
public interface WalletService {
     ...
     * @param userId : Customer which has requested creation of new wallet
     * @return : A newly created wallet object
     * @throws UserDoesNotExistException - if customer does not exist in the Customer table
     * @throws UserAlreadyHasWalletException - if customer already has a wallet. In our case one customer can only have one wallet
     */
//    public Wallet createWallet(Long userId) throws UserDoesNotExistException, UserAlreadyHasWalletException;
...
//    public Float getAccountBalanceForCurrentWallet(Integer walledId, Integer accountId) throws WalletIdDoesNotExistException, AccountNotAssociatedWithWalletException;
     ...
     */
//    public Account withdrawFromAccount(long walletId, long accountId, Float amount, String type) throws WalletIdDoesNotExistException,
//            AccountNotAssociatedWithWalletException, InsufficientBalanceInWalletException;
     ...
     * @throws AccountNotAssociatedWithWalletException- if account is not associated with the walletId parameter
     */
//    public Account depositToAccount(long walletId, long accountId, Float amount, String type) throws WalletIdDoesNotExistException,
//            AccountNotAssociatedWithWalletException;
     ...
     * @throws InsufficientBalanceInWalletException - if amount to be withdrawn > balance (Assumes you can also withdraw 1 cents)
     */
//    public void transferToAccount(long fromWalletId, long fromAccountId, long toWalletId, long toAccountId, Float amount) throws WalletIdDoesNotExistException,
//            AccountNotAssociatedWithWalletException, InsufficientBalanceInWalletException;
